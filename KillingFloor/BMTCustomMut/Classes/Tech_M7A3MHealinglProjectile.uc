class Tech_M7A3MHealinglProjectile extends MP7MHealinglProjectile;
    ...
    if( Role == ROLE_Authority )
    {
            ...
            Healed.Health <  Healed.HealthMax )
        {
     		...
     		if ( PRI != None )
    		{
                ...
                if( Tech_M7A3MMedicGun(Instigator.Weapon) != none )
                {
                    Tech_M7A3MMedicGun(Instigator.Weapon).ClientSuccessfulHeal(Healed.PlayerReplicationInfo.PlayerName);
                }
    		}
        }
    }
