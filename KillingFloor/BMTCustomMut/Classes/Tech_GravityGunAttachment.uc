Class Tech_GravityGunAttachment extends Tech_HL2WeaponAttachment;

var transient Tech_FX_GravityGunFBolt BoltFX;
...
simulated function DrawTraceHit( vector Start, vector HL, vector HN, Actor Other )
{
	...
	if( BoltFX==None )
	{
		BoltFX = Spawn(Class'Tech_FX_GravityGunFBolt');
