Class RTurretLazor extends Emitter
	Transient;

var RPortalTurret TurretOwner;
var BeamEmitter BM;

simulated function BeginPlay()
{
	TurretOwner = RPortalTurret(Owner);
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter0
         ...
         Texture=Texture'RocketPortalTurret.TransTrailT'
         LifetimeRange=(Min=0.100000,Max=0.100000)
     End Object
     Emitters(0)=BeamEmitter'RTurretLazor.BeamEmitter0'
