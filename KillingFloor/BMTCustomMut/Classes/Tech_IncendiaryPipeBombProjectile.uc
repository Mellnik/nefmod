class Tech_IncendiaryPipeBombProjectile extends Projectile;
...
var     float           BurnDamage; // // damage amount for the second hit, which will determine the continuous burn damage
var     class<KFWeaponDamageType> BurnDamageType;
    ...
    foreach CollidingActors (class 'Actor', Victims, DamageRadius, HitLocation)
    {
         ...
         && ExtendedZCollision(Victims)==None )
        {
           ...
           // Explosion hit
			...
			/*
            // Burn hit
            Victims.TakeDamage(damageScale * BurnDamage, Instigator, Victims.Location - 0.5 * (Victims.CollisionHeight + Victims.CollisionRadius)
             * dir, (damageScale * Momentum * dir), BurnDamageType);
			*/
...
{
    if( damageType == class'DamTypeTech_PipeBomb' || damageType == class'DamTypeTech_IncendiaryPipeBomb' ||(Damage < 25 && damageType != class'SirenScreamDamage') )
    {
        return;
    }
...
defaultproperties
{
     ...
     BurnDamage=30.000000
     BurnDamageType=Class'BMTCustomMut.DamTypeTech_PipeBombBurned'
     Speed=50.000000
     MaxSpeed=50.000000
     TossZ=0.000000
     Damage=1000.000000
     ...
     MyDamageType=Class'BMTCustomMut.DamTypeTech_IncendiaryPipeBomb'
