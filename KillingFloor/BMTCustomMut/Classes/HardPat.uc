...
function NotifySyringeB()
{
    ...
    SpawnMinionsAtSelf(class'ZombieBabySantatriarch', SyringeCount + 1);
}
...
state FireMissile
{
    ...
    function AnimEnd( int Channel )
    {
        ...
        if ( !SavedFireProperties.bInitialized )
        {
            ...
            SavedFireProperties.ProjectileClass = Class'ZombieBossSantatriarchProj';
        ...
        Spawn(Class'ZombieBossSantatriarchProj',,,Start,R);
...
defaultproperties
{
     HealingLevels(0)=5000
     HealingLevels(1)=5000
     ...
     DetachedArmClass=Class'BMTCustomMut.SeveredArmMP'
     DetachedLegClass=Class'BMTCustomMut.SeveredLegMP'
     DetachedHeadClass=Class'BMTCustomMut.SeveredHeadMP'
     HeadHealth=75000.000000
     PlayerNumHeadHealthScale=5.000000
