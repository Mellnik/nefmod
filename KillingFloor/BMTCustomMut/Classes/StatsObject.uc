...
final function SetCustomValues( SRCustomProgress L )
{
	local int i,c;

	if( Class'BMTCustomMut'.Default.bOverrideUnusedCustomStats )
		CC.Length = 0;
...
final function GetCustomValues( SRCustomProgress L )
{
	local int i,c;
