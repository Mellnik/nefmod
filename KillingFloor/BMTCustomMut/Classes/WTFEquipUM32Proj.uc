class WTFEquipUM32Proj extends M79GrenadeProjectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
        Spawn(class'BMTCustomMut.WTFEquipUM32ProjExplosionEmitter',,,HitLocation + HitNormal*20,rotator(HitNormal));
...
defaultproperties
{
     ...
     Damage=400.000000
     MyDamageType=Class'BMTCustomMut.DamTypeUM32Proj'
     DrawScale=4.000000
}
