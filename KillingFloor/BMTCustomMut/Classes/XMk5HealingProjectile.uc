class XMk5HealingProjectile extends MP7MHealinglProjectile;
    ...
    if ( Role == ROLE_Authority )
    {
            ...
            Healed.Health <  Healed.HealthMax )
        {
     		...
     		if ( PRI != None )
    		{
                ...
                if( XMk5SMG(Instigator.Weapon) != none )
                {
                    XMk5SMG(Instigator.Weapon).ClientSuccessfulHeal(Healed.PlayerReplicationInfo.PlayerName);
                }
    		}
        }
    }
