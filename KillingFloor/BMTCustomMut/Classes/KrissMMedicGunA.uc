...
//=============================================================================
class KrissMMedicGunA extends MP7MMedicGun;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.KrissMFireA'
     FireModeClass(1)=Class'BMTCustomMut.KrissMAltFireA'
     Description="The 'Zekk has a very high rate of fire and is equipped with the attachment for the Horzine medical darts. "
     Priority=120
     GroupOffset=17
     PickupClass=Class'BMTCustomMut.KrissMPickupA'
     AttachmentClass=Class'BMTCustomMut.KrissMAttachmentA'
