class Tech_PlasmaCutterBullet extends Projectile;
...
defaultproperties
{
     ...
     MyDamageType=Class'BMTCustomMut.DamTypeTech_PlasmaCutter'
     ExplosionDecal=Class'BMTCustomMut.Tech_PlasmaCutterDecal'
