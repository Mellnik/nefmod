class DualFRevolverFire extends KFShotgunFire;
...
simulated function InitEffects()
{
    ...
    if ( (FlashEmitterClass != None) && ((Flash2Emitter == None) || Flash2Emitter.bDeleteMe) )
    {
        ...
        Weapon.AttachToBone(Flash2Emitter, DualFRevolver(Weapon).default.altFlashBoneName);
    }
...
event ModeDoFire()
{
	...
	DualFRevolver(Weapon).altFlashBoneName = DualFRevolver(Weapon).FlashBoneName;
	DualFRevolver(Weapon).FlashBoneName = bn;
...
defaultproperties
{
     ...
     FireRate=0.200000
     AmmoClass=Class'BMTCustomMut.FRevolverAmmo'
     ...
     ProjectileClass=Class'BMTCustomMut.FRevolverProjectile'
