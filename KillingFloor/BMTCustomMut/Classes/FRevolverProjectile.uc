...
//=============================================================================
class FRevolverProjectile extends LAWProj;
...
defaultproperties
{
     ...
     ExplosionEmitter=Class'BMTCustomMut.FRevolverImpact'
     FlameTrailEmitterClass=Class'BMTCustomMut.FRevolverTrail'
     ExplosionSoundVolume=1.650000
     ArmDistSquared=0.000000
     ImpactDamageType=Class'BMTCustomMut.DamTypeFProjectileImpact'
     ImpactDamage=100
     ...
     MyDamageType=Class'BMTCustomMut.DamTypeFRevolver'
