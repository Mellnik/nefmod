class ZombieShiverBase extends KFMonster;
...
defaultproperties
{
     ...
     DetachedArmClass=Class'BMTCustomMut.SeveredArmShiver'
     DetachedLegClass=Class'BMTCustomMut.SeveredLegShiver'
     DetachedHeadClass=Class'BMTCustomMut.SeveredHeadShiver'
