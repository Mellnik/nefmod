Class Tech_HL_BlueGravityGun extends Tech_HL_GravityGun;
...
defaultproperties
{
     ...
     Priority=250
     PickupClass=Class'BMTCustomMut.Tech_HL_BlueGravityGunPickup'
     AttachmentClass=Class'BMTCustomMut.Tech_BGravityGunAttachment'
