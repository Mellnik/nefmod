class WTFEquipCrossbow extends KFWeapon;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.WTFEquipCrossbowFire'
     ...
     InventoryGroup=4
     GroupOffset=1
     PickupClass=Class'BMTCustomMut.WTFEquipCrossbowPickup'
     PlayerViewOffset=(X=15.000000,Y=16.000000,Z=-12.000000)
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.WTFEquipCrossbowAttachment'
     IconCoords=(X1=253,Y1=146,X2=333,Y2=181)
     ItemName="Xbow Proffession"
     LightType=LT_None
