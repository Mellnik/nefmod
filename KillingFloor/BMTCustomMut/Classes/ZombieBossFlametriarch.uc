Class ZombieBossFlametriarch extends ZombieBoss;
...
state FireMissile
{
    ...
    function AnimEnd( int Channel )
    {
        ...
        if ( !SavedFireProperties.bInitialized )
        {
            ...
            SavedFireProperties.ProjectileClass = Class'ZombieBossFlametriarchProj';
        ...
        Spawn(Class'ZombieBossFlametriarchProj',,,Start,R);
...
defaultproperties
{
     ...
     HealthMax=70500.000000
     Health=70500
     MenuName="Flametriarch"
     ControllerClass=Class'BMTCustomMut.HardPatController'
     LODBias=4.000000
     Skins(1)=Texture'CakeSpecialwep_Tex.Zombie_Pat.pat_D'
}
