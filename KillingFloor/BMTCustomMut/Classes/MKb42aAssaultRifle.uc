...
//=============================================================================
class MKb42aAssaultRifle extends KFWeapon
	config(user);
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.MKb42aFire'
     ...
     InventoryGroup=3
     GroupOffset=13
     PickupClass=Class'BMTCustomMut.MKb42aPickup'
     PlayerViewOffset=(X=20.000000,Y=18.000000,Z=-6.000000)
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.MKb42aAttachment'
