class WTFEquipLethalInjectionProj extends WTFFlamerProj;
				...
				*/
				if (StuckTo.OriginalGroundSpeed > SlowedGroundSpeed)
					...
					else
					{
						...
						Log("WTFEquipLethalInjectionProj: Timer(): I'm stuck to a Patriarch-type monster!");
						Log("WTFEquipLethalInjectionProj: Timer(): OriginalGroundSpeed reduced to " $ StuckTo.OriginalGroundSpeed $ " instead of " $ SlowedGroundSpeed);
					}
...
defaultproperties
{
     ...
     MyDamageType=Class'BMTCustomMut.WTFEquipDamTypeLethalInjection'
