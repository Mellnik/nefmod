...
// Colt Fire
//=============================================================================
class WColtFire extends KFFire;
...
defaultproperties
{
     ...
     StereoFireSound=Sound'Whisky_Colt_S.357_fire3'
     DamageMin=700
     DamageMax=900
     ...
     TweenTime=0.025000
     FireSound=Sound'Whisky_Colt_S.357_fire3'
     NoAmmoSound=Sound'KF_9MMSnd.9mm_DryFire'
     FireForce="AssaultRifleFire"
     FireRate=0.900000
     AmmoClass=Class'BMTCustomMut.WColtAmmo'
     AmmoPerFire=1
     ...
     ProjectileClass=Class'BMTCustomMut.WColtBullet'
