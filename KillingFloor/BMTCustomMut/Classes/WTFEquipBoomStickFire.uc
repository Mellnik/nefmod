class WTFEquipBoomStickFire extends BoomStickFire;
...
function SetShellType(int type)
{
	...
	{
		ProjPerFire=1;
		ProjectileClass=Class'BMTCustomMut.WTFEquipBoomStickSlug';
...
defaultproperties
{
     ...
     AmmoClass=Class'BMTCustomMut.WTFEquipBoomStickAmmo'
