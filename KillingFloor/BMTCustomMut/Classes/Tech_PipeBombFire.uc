class Tech_PipeBombFire extends KFShotgunFire;
...
defaultproperties
{
     ...
     TransientSoundRadius=950.000000
     FireAnim="Toss"
     NoAmmoSound=None
     FireRate=1.750000
     AmmoClass=Class'BMTCustomMut.Tech_PipeBombAmmo'
     ProjectileClass=Class'BMTCustomMut.Tech_PipeBombProjectile'
