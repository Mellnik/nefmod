Class ZombieBossRapetriarch extends ZombieBoss;
...
simulated function PostNetBeginPlay()
{
	...
	SetBoneScale(14,1.5,'rleg');
	SetBoneScale(15,1.5,'lleg');
	
	SetBoneScale(2,1.5,'rshoulder');
	SetBoneScale(3,1.5,'lshoulder');
}
...
defaultproperties
{
     HealingLevels(0)=10000
     HealingLevels(1)=8000
     HealingLevels(2)=6000
     HealingAmount=5000
     MGDamage=25.000000
     ...
     HealthMax=50500.000000
     Health=50500
     HeadHeight=2.250000
     HeadScale=1.500000
     MenuName="Rapetriarch"
