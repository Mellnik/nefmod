...
simulated function DoToggle ()
{
	...
	if ( Player!=None )
	{
		...
		if (bBulletType)
		{
			Player.ReceiveLocalizedMessage(class'BMTCustomMut.HK417SwitchMessage',1);
		}
		else
		{
			Player.ReceiveLocalizedMessage(class'BMTCustomMut.HK417SwitchMessage',0);
		}
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.HK417Fire'
     ...
     InventoryGroup=4
     GroupOffset=4
     PickupClass=Class'BMTCustomMut.HK417Pickup'
     PlayerViewOffset=(X=14.000000,Y=7.000000,Z=-4.000000)
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.HK417Attachment'
