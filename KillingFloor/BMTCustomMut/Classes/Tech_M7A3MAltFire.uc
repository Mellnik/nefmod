class Tech_M7A3MAltFire extends KFShotgunFire;
...
simulated function bool AllowFire()
{
	...
	return Tech_M7A3MMedicGun(Weapon).HealAmmoCharge >= AmmoPerFire;
}
...
defaultproperties
{
     ...
     ProjectileClass=Class'BMTCustomMut.Tech_M7A3MHealinglProjectile'
