class WTFEquipCrossbowArrow extends Projectile;
...
defaultproperties
{
     DamageTypeHeadShot=Class'BMTCustomMut.DamTypeWTFCrossbow'
     ...
     MyDamageType=Class'BMTCustomMut.DamTypeWTFCrossbow'
