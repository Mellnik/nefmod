...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.WTFEquipFireAxeFire'
     FireModeClass(1)=Class'BMTCustomMut.WTFEquipFireAxeFireB'
     Description="A deadly weapon"
     Priority=194
     PickupClass=Class'BMTCustomMut.WTFEquipFireAxePickup'
     AttachmentClass=Class'BMTCustomMut.WTFEquipFireAxeAttachment'
     ItemName="FIRE Axe"
     LightType=LT_None
     LightSaturation=0
