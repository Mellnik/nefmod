...
function AddDamageHealed(int Amount, optional bool bMP7MHeal, optional bool bMP5MHeal)
{
	...
	if((Rep.RDamageHealedStat+Amount)<0 || (Rep.RDamageHealedStat+Amount)>2000000000)
	{
		Rep.RDamageHealedStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.DamageHealedStat=2000000000;
	}
	DelayedStatCheck();
}
function AddWeldingPoints(int Amount)
{
	...
	if((Rep.RWeldingPointsStat+Amount)<0 || (Rep.RWeldingPointsStat+Amount)>2000000000)
	{
		Rep.RWeldingPointsStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.WeldingPointsStat=2000000000;
	}
	DelayedStatCheck();
}
function AddShotgunDamage(int Amount)
{
	...
	if((Rep.RShotgunDamageStat+Amount)<0 || (Rep.RShotgunDamageStat+Amount)>2000000000)
	{
		Rep.RShotgunDamageStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.ShotgunDamageStat=2000000000;
	}
	DelayedStatCheck();
}
function AddHeadshotKill(bool bLaserSightedEBRHeadshot)
{
	...
	if((Rep.RHeadshotKillsStat+1)<0 || (Rep.RHeadshotKillsStat+1)>2000000000)
	{
		Rep.RHeadshotKillsStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.HeadshotKillsStat=2000000000;
	}
	DelayedStatCheck();
}
function AddStalkerKill()
{
	...
	if((Rep.RStalkerKillsStat+1)<0 || (Rep.RStalkerKillsStat+1)>2000000000)
	{
		Rep.RStalkerKillsStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.StalkerKillsStat=2000000000;
	}
	DelayedStatCheck();
}
function AddBullpupDamage(int Amount)
{
	...
	if((Rep.RBullpupDamageStat+Amount)<0 || (Rep.RBullpupDamageStat+Amount)>2000000000)
	{
		Rep.RBullpupDamageStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.BullpupDamageStat=2000000000;
	}
	DelayedStatCheck();
}
...
function AddMeleeDamage(int Amount)
{
	...
	if((Rep.RMeleeDamageStat+Amount)<0 || (Rep.RMeleeDamageStat+Amount)>2000000000)
	{
		Rep.RMeleeDamageStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.MeleeDamageStat=2000000000;
	}
	DelayedStatCheck();
}
...
function AddFlameThrowerDamage(int Amount)
{
	...
	if((Rep.RFlameThrowerDamageStat+Amount)<0 || (Rep.RFlameThrowerDamageStat+Amount)>2000000000)
	{
		Rep.RFlameThrowerDamageStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.FlameThrowerDamageStat=2000000000;		
	}	
	DelayedStatCheck();
}
function WaveEnded()
...
function AddExplosivesDamage(int Amount)
{
	...
	if((Rep.RExplosivesDamageStat+Amount)<0 || (Rep.RExplosivesDamageStat+Amount)>2000000000)
	{
		Rep.RExplosivesDamageStat=2000000000;
		if( MyStatsObject!=None )
			MyStatsObject.ExplosivesDamageStat=2000000000;
	}
}
