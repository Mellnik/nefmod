...
class HardPatZombieBossBase extends KFMonster;
...
{
     ChargingAnim="RunF"
     HealingLevels(0)=20000
     HealingLevels(1)=20000
     HealingLevels(2)=20000
     HealingAmount=40000
     ...
     PlayerCountHealthScale=5.000000
     OnlineHeadshotOffset=(X=28.000000,Z=75.000000)
     OnlineHeadshotScale=5.000000
