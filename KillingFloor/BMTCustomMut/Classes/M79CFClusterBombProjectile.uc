class M79CFClusterBombProjectile extends ROBallisticProjectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
		Spawn(class'BMTCustomMut.M79CFExplosionEmitter',self,,HitLocation + HitNormal*20,rotator(HitNormal));
    }
...
defaultproperties
{
     ProjectileClass=Class'BMTCustomMut.M79CFClusterBomblet'
     NumProjectiles=4
     ...
     MyDamageType=Class'BMTCustomMut.DamTypeWTFM79Demo'
