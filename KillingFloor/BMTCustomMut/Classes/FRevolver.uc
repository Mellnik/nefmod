...
//=============================================================================
class FRevolver extends KFWeapon;
...
{
	if ( Instigator.PendingWeapon.class == class'DualFRevolver' )
	{
		bIsReloading = false;
	}
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.FRevolverFire'
     ...
     InventoryGroup=2
     GroupOffset=5
     PickupClass=Class'BMTCustomMut.FRevolverPickup'
     PlayerViewOffset=(X=20.000000,Y=18.000000,Z=-8.000000)
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.FRevolverAttachment'
