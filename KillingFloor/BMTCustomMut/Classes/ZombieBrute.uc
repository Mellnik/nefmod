class ZombieBrute extends ZombieBruteBase;
...
defaultproperties
{
     DetachedArmClass=Class'BMTCustomMut.SeveredArmBrute'
     DetachedLegClass=Class'BMTCustomMut.SeveredLegBrute'
     DetachedHeadClass=Class'BMTCustomMut.SeveredHeadBrute'
     ControllerClass=Class'BMTCustomMut.BruteZombieController'
}
