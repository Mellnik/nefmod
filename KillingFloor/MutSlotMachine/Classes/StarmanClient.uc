Class StarmanClient extends Emitter;

#exec AUDIO IMPORT FILE="Sounds\PowerUp.WAV" NAME="StarOn" GROUP="FX"
#exec AUDIO IMPORT FILE="Sounds\PowerDown.WAV" NAME="StarOff" GROUP="FX"
#exec AUDIO IMPORT FILE="Sounds\starman.wav" NAME="StarLoop" GROUP="FX"
...
function Timer()
{
	if( !bHasInit )
	{
		...
		SetTimer(Class'StarmanCard'.Default.StarmanTime,false);
		return;
	}
	Disable('Tick');
	SetTimer(0.f,false);
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'MutSlotMachine.StarmanClient.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'MutSlotMachine.StarmanClient.SpriteEmitter1'
