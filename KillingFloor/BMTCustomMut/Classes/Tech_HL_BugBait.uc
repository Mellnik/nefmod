Class Tech_HL_BugBait extends Tech_HL2Weapon;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.Tech_BugBaitFire'
     FireModeClass(1)=Class'BMTCustomMut.Tech_BugBaitAltFire'
     Description="Bug bait."
     Priority=190
     InventoryGroup=4
     GroupOffset=8
     PickupClass=Class'BMTCustomMut.Tech_HL_BugBaitPickup'
     PlayerViewPivot=(Yaw=-16384)
     AttachmentClass=Class'BMTCustomMut.Tech_BugBaitAttachment'
     ItemName="Pheropod"
