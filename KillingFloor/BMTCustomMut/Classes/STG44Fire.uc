//=============================================================================
 //AK47 Fire
//=============================================================================
class STG44Fire extends KFFire;
...
defaultproperties
{
     ...
     StereoFireSound=SoundGroup'KF1945WepSnd.stg44.STG44A'
     bRandomPitchFireSound=False
     DamageType=Class'BMTCustomMut.DamTypeSTG44'
     DamageMin=35
     DamageMax=45
     ...
     FireEndAnim=
     TweenTime=0.025000
     FireSound=SoundGroup'KF1945WepSnd.stg44.STG44A'
     NoAmmoSound=Sound'KF_AK47Snd.AK47_DryFire'
     FireForce="AssaultRifleFire"
     FireRate=0.125000
     AmmoClass=Class'BMTCustomMut.STG44Ammo'
     AmmoPerFire=1
