...
class ZombieBossFleshpoundtriarch extends ZombieBoss;
...
state FireChaingun
{
    ...
    function TakeDamage( int Damage, Pawn InstigatedBy, Vector Hitlocation, Vector Momentum, class<DamageType> damageType, optional int HitIndex)
    {
        ...
        if (InstigatedBy.isa('ZombieBabySantatriarch'))
            Damage = 0; // nulled
        else
        {
...
function PlayTakeHit(vector HitLocation, int Damage, class<DamageType> DamageType)
{
    ...
    if( Damage>=350 || (DamageType.name=='DamTypeStunNade' && rand(5)>3) || (DamageType.name=='DamTypeCrossbowHeadshot' && Damage>=350) || (DamageType.name=='DamTypeM44' && Damage>=350) || (DamageType.name=='DamTypeM99' && Damage>=350) || (DamageType.name=='DamTypeM99HeadShot' && Damage>=350) || (DamageType.name=='DamTypeGaussRifle' && Damage>=350) || (DamageType.name=='DamTypeGaussRifleHeadShot' && Damage>=350) )
...
defaultproperties
{
     ...
     HealthMax=35500.000000
     Health=35500
     MenuName="Fleshpoundtriarch"
