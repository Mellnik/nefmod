class Tech_PipeBombExplosive extends KFWeapon;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.Tech_PipeBombFire'
     ...
     InventoryGroup=4
     GroupOffset=11
     PickupClass=Class'BMTCustomMut.Tech_PipeBombPickup'
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.Tech_PipeBombAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="Extreme PipeBomb"
