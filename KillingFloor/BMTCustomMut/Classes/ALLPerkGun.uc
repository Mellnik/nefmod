class ALLPerkGun extends KFWeapon;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BMTCustomMut.ALLPerkGunFire'
     ...
     Description="A classic millitary sub machine gun that holds a 100 bullet magazine."
     ...
     InventoryGroup=4
     GroupOffset=4
     PickupClass=Class'BMTCustomMut.ALLPerkGunPickup'
     PlayerViewOffset=(X=25.000000,Y=22.000000,Z=-6.000000)
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.ALLPerkGunAttachment'
