...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         SizeScale(0)=(RelativeSize=0.000100)
         SizeScale(1)=(RelativeTime=0.000100,RelativeSize=0.000100)
         SizeScale(2)=(RelativeTime=0.000100,RelativeSize=0.000100)
         SizeScale(3)=(RelativeTime=0.000100,RelativeSize=0.000100)
         StartSizeRange=(X=(Min=0.000100,Max=0.000100))
     ...
     End Object
     Emitters(0)=SpriteEmitter'BMTCustomMut.PanzerfaustTrail.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         VelocityScale(2)=(RelativeTime=1.000000,RelativeVelocity=(Y=0.400000,Z=0.400000))
     End Object
     Emitters(1)=SpriteEmitter'BMTCustomMut.PanzerfaustTrail.SpriteEmitter1'
