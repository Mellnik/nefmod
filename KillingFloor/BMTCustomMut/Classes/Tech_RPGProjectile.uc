Class Tech_RPGProjectile extends Tech_HL2Projectile;

var Tech_HL_RPG MyWeapon;
var Tech_FX_LaserDot TrackingTarget;
var Tech_FX_RPGTrail MyTrail;
...
simulated function ArmRocket()
{
	if( Level.NetMode!=NM_DedicatedServer )
	{
		if( MyTrail==None )
		{
			MyTrail = Spawn(Class'Tech_FX_RPGTrail',,,Location-vector(Rotation)*15);
...
defaultproperties
{
     ...
     MyDamageType=Class'BMTCustomMut.DamTypeTech_RPG'
