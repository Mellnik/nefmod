...
#exec obj load file="Poe.ukx" Package="MutSlotMachine"
...
defaultproperties
{
     ...
     AirControl=1.000000
     MenuName="Reaper"
     ControllerClass=Class'MutSlotMachine.ReaperAI'
     bPhysicsAnimUpdate=False
     MovementAnims(0)="Idle"
     bAlwaysRelevant=True
     Physics=PHYS_Flying
     Mesh=SkeletalMesh'MutSlotMachine.PoeMesh'
     DrawScale=0.700000
     Skins(0)=FinalBlend'MutSlotMachine.Skins.JReaperFB'
     AmbientGlow=250
     bUnlit=True
