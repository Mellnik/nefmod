...
defaultproperties
{
	...
	Perks(0)="NEFCustomPerksP.SRVetSupportSpec"
	Perks(1)="NEFCustomPerksP.SRVetBerserker"
	Perks(2)="NEFCustomPerksP.SRVetCommando"
	Perks(3)="NEFCustomPerksP.SRVetFieldMedic"
	Perks(4)="NEFCustomPerksP.SRVetFirebug"
	...
	SmileyTags(0)=(IconTag=">:(",IconTexture="NEFCustomPerks.I_Mad")
	SmileyTags(1)=(IconTag=":(",IconTexture="NEFCustomPerks.I_Frown")
	SmileyTags(2)=(IconTag=":)",IconTexture="NEFCustomPerks.I_GreenLickB")
	SmileyTags(3)=(IconTag=":P",IconTexture="NEFCustomPerks.I_Tongue",bCaseInsensitive=true)
	SmileyTags(4)=(IconTag=":d",IconTexture="NEFCustomPerks.I_GreenLick")
	SmileyTags(5)=(IconTag=":D",IconTexture="NEFCustomPerks.I_BigGrin")
	SmileyTags(6)=(IconTag=":|",IconTexture="NEFCustomPerks.I_Indiffe")
	SmileyTags(7)=(IconTag=":/",IconTexture="NEFCustomPerks.I_Ohwell")
	SmileyTags(8)=(IconTag=":*",IconTexture="NEFCustomPerks.I_RedFace")
	SmileyTags(9)=(IconTag=":-*",IconTexture="NEFCustomPerks.I_RedFace")
	SmileyTags(10)=(IconTag="Ban?",IconTexture="NEFCustomPerks.I_Ban",bCaseInsensitive=true)
	SmileyTags(11)=(IconTag="B)",IconTexture="NEFCustomPerks.I_Cool")
	SmileyTags(12)=(IconTag="Hmm",IconTexture="NEFCustomPerks.I_Hmm")
	SmileyTags(13)=(IconTag="XD",IconTexture="NEFCustomPerks.I_Scream")
	SmileyTags(14)=(IconTag="SPAM",IconTexture="NEFCustomPerks.I_Spam")
}