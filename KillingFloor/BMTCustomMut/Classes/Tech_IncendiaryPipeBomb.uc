class Tech_IncendiaryPipeBomb extends KFWeapon;
...
var texture ArmedSkin3;

static function PreloadAssets(Inventory Inv, optional bool bSkipRefCount)
{
	default.ArmedSkin1 = texture(DynamicLoadObject("SentryTechTex1.Weapon_IncendiaryPipeBomb.IncendiaryPipeBomb_D", class'texture', true));
	default.ArmedSkin2 = texture(DynamicLoadObject("KF_Weapons2_Trip_T.Special.Pipebomb_RLight_OFF", class'texture', true));
	default.ArmedSkin3 = texture(DynamicLoadObject("KF_Weapons2_Trip_T.Special.Pipebomb_GLight_shdr", class'texture', true));
...
defaultproperties
{
     ...
     SleeveNum=3
     TraderInfoTexture=Texture'SentryTechTex1.Weapon_IncendiaryPipeBomb.IncendiaryPipeBomb_Trader'
     MeshRef="KF_Weapons2_Trip.PipeBomb_Trip"
     SkinRefs(0)="SentryTechTex1.Weapon_IncendiaryPipeBomb.IncendiaryPipeBomb_D"
     ...
     HudImageRef="SentryTechTex1.Weapon_IncendiaryPipeBomb.IncendiaryPipeBomb_unselected"
     SelectedHudImageRef="SentryTechTex1.Weapon_IncendiaryPipeBomb.IncendiaryPipeBomb_Selected"
     FireModeClass(0)=Class'BMTCustomMut.Tech_IncendiaryPipeBombFire'
     ...
     InventoryGroup=4
     GroupOffset=6
     PickupClass=Class'BMTCustomMut.Tech_IncendiaryPipeBombPickup'
     BobDamping=6.000000
     AttachmentClass=Class'BMTCustomMut.Tech_IncendiaryPipeBombAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="Incendiary PipeBomb"
