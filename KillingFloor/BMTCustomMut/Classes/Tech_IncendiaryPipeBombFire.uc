class Tech_IncendiaryPipeBombFire extends KFShotgunFire;
...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	if (KFPRI != none)
	{
		if (KFPRI.ClientVeteranSkill == Class'BMTCustomMut.WTFPerksSentryTechPerk')
			ProjectileClass=Class'BMTCustomMut.Tech_IncendiaryPipeBombProjectile';
...
defaultproperties
{
     ...
     NoAmmoSound=None
     FireRate=1.750000
     AmmoClass=Class'BMTCustomMut.Tech_IncendiaryPipeBombAmmo'
     ProjectileClass=Class'BMTCustomMut.Tech_IncendiaryPipeBombProjectile'
