Class GodModeClient extends Emitter;

#exec AUDIO IMPORT FILE="Sounds\siroof.wav" NAME="IronShieldOff" GROUP="FX"
#exec AUDIO IMPORT FILE="Sounds\siroon.wav" NAME="IronShieldOn" GROUP="FX"
...
function BeginPlay()
{
	...
	SetTimer(Class'GodModeCard'.Default.GodModeTime,false);
}
function Timer()
{
	SetTimer(0.f,false);
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'MutSlotMachine.GodModeClient.SpriteEmitter0'
